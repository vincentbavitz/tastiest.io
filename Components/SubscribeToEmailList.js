                    ...
                    <div>
                        ...
                        <form>
                            <div className='flex justify-center rounded-t-md mx-8 my-0'>
                                    <input autocapitalize="none" className="bg-white border-orange-400 rounded-t-md w-full py-4 px-8 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-orange-500" placeholder="email..."/>                             
                            </div>
